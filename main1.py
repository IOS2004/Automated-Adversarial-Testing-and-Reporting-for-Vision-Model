...
for epsilon in epsilon_arr:
    ...
    #         print(label.shape)
            ...
            # Save FGSM adversarial image
            save_adversarial_image(fg_adv_img, img_name, 'fgsm', epsilon)
...
#             adv_pred_prob =  ((torch.max(op_adv_probs.data, 1)[0][0]) * 100, 4)      #find probability (confidence) of a predicted class
    ...
    #         print(int(label),int(pred_adv))
            ...
            # Save BIM adversarial image
            save_adversarial_image(bim_adv_img, img_name, 'bim', epsilon)
            ...
            # Save PGD adversarial image
            save_adversarial_image(pgd_adv_img, img_name, 'pgd', epsilon)
