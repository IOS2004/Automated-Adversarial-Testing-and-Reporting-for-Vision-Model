...
for epsilon in epsilon_arr:
    ...
    #         print(label.shape)
            ...
            # Save targeted FGSM adversarial image
            save_adversarial_image(fg_adv_img, img_name, 'fgsm_targeted', epsilon)
...
#             adv_pred_prob =  ((torch.max(op_adv_probs.data, 1)[0][0]) * 100, 4)      #find probability (confidence) of a predicted class
    ...
    #         print(int(label),int(pred_adv))
            ...
            # Save targeted BIM adversarial image
            save_adversarial_image(bim_adv_img, img_name, 'bim_targeted', epsilon)
